export const CakeIcon = ({ className }: { className?: string }) => (
  ...
  >
    <path
      ...
      d="M21 11.25v8.25a1.5 1.5 0 0 1-1.5 1.5H5.25a1.5 1.5 0 0 1-1.5-1.5v-8.25M12 4.875A3.375 3.375 0 0 0 8.625 1.5H7.5a3.375 3.375 0 0 0-3.375 3.375v.375m15 0v-.375a3.375 3.375 0 0 0-3.375-3.375h-1.125A3.375 3.375 0 0 0 12 4.875v11.25"
    />
  </svg>
);
...
export const InstagramIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    fill="currentColor"
  >
    <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.85s-.011 3.584-.069 4.85c-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07s-3.584-.012-4.85-.07c-3.252-.148-4.771-1.691-4.919-4.919-.058-1.265-.069-1.645-.069-4.85s.011-3.584.069-4.85c.149-3.225 1.664-4.771 4.919-4.919C8.416 2.175 8.796 2.163 12 2.163zm0 1.441c-3.171 0-3.535.012-4.774.069-2.734.124-3.958 1.344-4.082 4.082-.057 1.239-.068 1.598-.068 4.774s.011 3.535.068 4.774c.124 2.738 1.348 3.958 4.082 4.082 1.239.057 1.603.068 4.774.068s 3.535-.011 4.774-.068c 2.734-.124 3.958-1.344 4.082-4.082.057-1.239.068-1.598.068-4.774s-.011-3.535-.068-4.774c-.124-2.738-1.348-3.958-4.082-4.082-1.239-.057-1.603-.068-4.774-.068z" />
    <path d="M12 6.865a5.135 5.135 0 100 10.27 5.135 5.135 0 000-10.27zm0 8.843a3.708 3.708 0 110-7.416 3.708 3.708 0 010 7.416z" />
    <path d="M16.949 6.032a1.25 1.25 0 100 2.5 1.25 1.25 0 000-2.5z" />
  </svg>
);
